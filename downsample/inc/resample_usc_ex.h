...
#ifndef __RESAMPLE_USC_EX_H__
#define __RESAMPLE_USC_EX_H__
...
typedef struct Resample
{
  ...
  float factor;              /* factor = outSampleRate/inSampleRate */
  BOOL interpFilt;
  int nChans;
...
//unsigned int usc_resampleInit();
//unsigned int usc_resampleWithFilterEx(const short *in1, const short *in2, short *out1, short *out2);

#endif  //__RESAMPLE_USC_EX_H__
